const themeConfig = {
  ...
  normal: {
    ...
    gradient: {
      primary: 'text-transparent bg-clip-text bg-gradient-to-r from-[#3374FF] to-[#2861E5]'
    },
    badge: {
      base: 'inline-block px-3 py-1 text-sm font-medium rounded-full',
      variants: {
        primary: 'bg-[#3374FF]/10 text-[#3374FF]',
  ...
  tech: {
    ...
    gradient: {
      primary: 'text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-500 to-violet-500'
    },
    badge: {
      base: 'inline-block px-3 py-1 text-sm font-medium rounded-full backdrop-blur-xl',
      variants: {
        primary: 'bg-indigo-100/50 text-indigo-600',
        secondary: 'bg-gray-100/50 text-gray-600'
      }
    }
  },
};
