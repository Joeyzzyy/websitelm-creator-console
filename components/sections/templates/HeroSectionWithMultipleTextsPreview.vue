        ...
        <div class="relative z-10 pt-8 md:pt-12">
          ...
          <div class="pt-6 flex justify-center gap-3 flex-wrap">
            ...
            <a
              ...
              target="_blank"
              class="inline-flex items-center px-6 py-3 rounded-xl text-base font-semibold transition-all duration-200 bg-[#5865F2] text-white hover:bg-[#4752C4] hover:scale-105 border-2 border-white"
            >
